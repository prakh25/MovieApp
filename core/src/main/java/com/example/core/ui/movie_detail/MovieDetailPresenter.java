...
import com.example.core.model.movie_detail.tmdb.Video;
import com.example.core.model.movie_detail.trakt.TraktMovieRating;
import com.example.core.model.realm.Favorite;
import com.example.core.model.realm.MovieItem;
import com.example.core.model.realm.MovieStatus;
import com.example.core.model.realm.UserList;
import com.example.core.model.realm.UserRating;
import com.example.core.model.realm.WatchList;
import com.example.core.model.release_dates.ReleaseDatesResult;
...
import static com.example.core.utils.Constants.FIELD_LIST_ID;
import static com.example.core.utils.Constants.FIELD_MOVIE_ID;
...
public class MovieDetailPresenter extends BasePresenter<MovieDetailContract.DetailView>
    ...
    private void showMovieDetail(Pair moviePair) {
        ...
        mView.showMovieHeader(tmdbMovieDetail);
    ...
    private void showMovieStatus(GenericMovieDataWrapper wrapper) {
        ...
        MovieStatus realmResult = findInRealmMovieStatus(realm, wrapper.getMovieId());
